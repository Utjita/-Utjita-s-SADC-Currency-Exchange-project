...
class MainApplication(tk.Frame):
    ...
    # gets the data about the exchange rate relative to NAD
    def exchanges_list_comp_usd(self):
        exchanges = []
        try:
            exchanges = [["US Dollar", "1"]]
            # text = requests.get("https://www.x-rates.com/table/?from=NAD&amount=1")
            text = requests.get("https://v6.exchangerate-api.com/v6/5550f3768e93c3ed401d9881/latest/NAD")
